...
export const Spinner = ({ className = '' }: Props) => {
  const classNames = className + ' size-5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600'
  return (
    <div role='status'>
      <svg
        aria-hidden='true'
...
export const PencilSquare = ({ className }: Props) => {
  const classNames = className ?? 'size-4'
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
...
export const QuestionCircle = ({ className }: Props) => {
  const classNames = className ?? 'size-4'
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
